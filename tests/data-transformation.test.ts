...
// Type definitions from wsproxy.ts
...
// Mock data stores
let mockZlibCalls: Array<{ data: Buffer; options: object }> = [];
let mockIconvCalls: Array<{ str: string; encoding: string }> = [];
let lastEncodedData: Buffer | null = null;
...
function sendClient(
  s: SocketExtended & { _sentMessages: string[] },
  data: Buffer,
  options: { compress?: boolean; debug?: boolean } = {},
): void {
