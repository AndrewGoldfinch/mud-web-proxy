...
let mockChatLogData = null;
const mockFsFiles = new Map();
...
describe('Chat System', () => {
    ...
    describe('chat() function', () => {
        it('should broadcast basic chat message to all chat sockets', () => {
            ...
            const socket3HasChatMsg = socket3._sentMessages.some((msg) => msg.includes('portal.chat'));
    ...
    describe('chatUpdate() function', () => {
        ...
        it('should send channel op request to each socket with chat flag', () => {
            ...
            const msg1 = JSON.parse(socket1._sentMessages[0].replace('portal.chatlog ', ''));
    ...
    describe('chatCleanup() function', () => {
        ...
        it('should handle multiple angle brackets', () => {
            ...
            const result = chatCleanup(input);
            expect(result).toBe('x&lt;div&gt;&lt;span&gt;text&lt;/span&gt;&lt;/div&gt;');
        });
...
export { mockFs };
//# sourceMappingURL=chat-system.test.js.map