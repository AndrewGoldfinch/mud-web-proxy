...
| Shared-secret upgrade authorization, query opt-in, constant-time equality, bounded failed-auth tracking                              | `src/wsproxy-utils.ts`, `wsproxy.ts`                                          | `tests/shared-secret-auth.test.ts`, `tests/config-security-guards.test.ts`                                                                                                                      | —                                                                                     |
